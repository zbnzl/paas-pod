...
type Data struct {
	...
	K8S      *Data_K8S      `protobuf:"bytes,3,opt,name=k8s,proto3" json:"k8s,omitempty"`
}
...
func (x *Data_K8S) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_K8S) ProtoMessage() {}

func (x *Data_K8S) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_K8S.ProtoReflect.Descriptor instead.
func (*Data_K8S) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_K8S) GetConfigPath() string {
	if x != nil {
		return x.ConfigPath
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x64, 0x69, 0x73, 0x12, 0x26, 0x0a, 0x03, 0x6b, 0x38, 0x73, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x44, 0x61, 0x74, 0x61, 0x2e, 0x4b, 0x38, 0x53, 0x52, 0x03, 0x6b, 0x38, 0x73, 0x1a, 0x3a, 0x0a,
	...
	0x26, 0x0a, 0x03, 0x4b, 0x38, 0x53, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x50, 0x61, 0x74, 0x68, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x7a, 0x62, 0x6e, 0x7a, 0x6c, 0x2f, 0x70, 0x61, 0x61, 0x73,
	0x2d, 0x70, 0x6f, 0x64, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_K8S)(nil),            // 7: kratos.api.Data.K8S
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.k8s:type_name -> kratos.api.Data.K8S
