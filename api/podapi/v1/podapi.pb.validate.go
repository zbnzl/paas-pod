...
// Validate checks the field values on FindPodByIdRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *FindPodByIdRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on FindPodByIdRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// FindPodByIdRequestMultiError, or nil if none found.
func (m *FindPodByIdRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *FindPodByIdRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetPodId() <= 0 {
		err := FindPodByIdRequestValidationError{
			field:  "PodId",
	...
	if len(errors) > 0 {
		return FindPodByIdRequestMultiError(errors)
	}

	return nil
}

// FindPodByIdRequestMultiError is an error wrapping multiple validation errors
// returned by FindPodByIdRequest.ValidateAll() if the designated constraints
// aren't met.
type FindPodByIdRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m FindPodByIdRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
...
func (m FindPodByIdRequestMultiError) AllErrors() []error { return m }

// FindPodByIdRequestValidationError is the validation error returned by
// FindPodByIdRequest.Validate if the designated constraints aren't met.
type FindPodByIdRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e FindPodByIdRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e FindPodByIdRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e FindPodByIdRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e FindPodByIdRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e FindPodByIdRequestValidationError) ErrorName() string {
	return "FindPodByIdRequestValidationError"
}

// Error satisfies the builtin error interface
func (e FindPodByIdRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
	...
	return fmt.Sprintf(
		"invalid %sFindPodByIdRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = FindPodByIdRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = FindPodByIdRequestValidationError{}
